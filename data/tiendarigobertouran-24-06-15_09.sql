...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-06-2015 a las 16:52:20
...
(5, 'Camiseta Manga Corta', 'Camiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta', 'en', 1),
(6, 'Camiseta Manga Corta', 'Camiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\n', 'it', 2);
...
INSERT INTO `menu` (`idmenu`, `nombreitem`, `url`, `estado`, `idioma_abrevitura`, `orden`, `idunico`) VALUES
(0, 'Contact', 'contacto', 1, 'en', 'f', NULL),
(0, 'Contáctame', 'contacto', 1, 'es', 'f', NULL),
(0, 'Contatto', 'contacto', 1, 'it', 'f', NULL),
(1, 'Home', 'home', 1, 'en', 'a', NULL),
(2, 'Inicio', 'home', 1, 'es', 'a', NULL),
(3, 'iniziazione', 'home', 1, 'it', 'a', NULL),
(4, 'About me', 'profile', 1, 'en', 'e', NULL),
(5, 'Acerca de mi', 'profile', 1, 'es', 'e', NULL),
(6, 'Su di me', 'profile', 1, 'it', 'e', NULL),
(7, 'News', 'news', 1, 'en', 'd', NULL),
(8, 'Noticias', 'news', 1, 'es', 'd', NULL),
(9, 'Notizie', 'news', 1, 'it', 'd', NULL),
(10, 'Social work', 'social', 1, 'en', 'c', NULL),
(11, 'Labor social', 'social', 1, 'es', 'c', NULL),
(12, 'Lavoro sociale', 'social', 1, 'it', 'c', NULL),
(13, 'Shop', 'shop', 1, 'en', 'b', NULL),
(14, 'Tienda', 'shop', 1, 'es', 'b', NULL),
(15, 'Negozio', 'shop', 1, 'it', 'c', NULL);
...
(91, '196515', '2015-06-23 04:39:16', '98705290005628652', 888, -1, -1, -1, '-1', '-1', ' -1 ', -1, -1, '-1'),
...
(2, 'Rigo Pro Nacional', '1', 'Rigo-Uran-Uniformes-51.jpg', 'Rigo-Uran-Uniformes-56.jpg', 'Rigo-Uran-Uniformes-57.jpg', NULL, 175000, 200000, 'Camisa Rigoberto uran', 'n', '2015rupn01');
...
--
ALTER TABLE `menu`
 ADD PRIMARY KEY (`idmenu`,`idioma_abrevitura`), ADD UNIQUE KEY `idunico_UNIQUE` (`idunico`), ADD KEY `fk_menu_idioma_idx` (`idioma_abrevitura`);
...
--
ALTER TABLE `clientescompra`
MODIFY `idclientescompra` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `detallepagos`
MODIFY `iddetallepagos` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=51;
--
-- AUTO_INCREMENT de la tabla `detallexproducto`
--
ALTER TABLE `detallexproducto`
MODIFY `iddetallexproducto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `pagos`
MODIFY `idpagos` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=92;
--
