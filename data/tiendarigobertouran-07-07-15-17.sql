...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2015 a las 00:50:31
...
`idclientescompra` int(11) NOT NULL,
  ...
  `apellidocliente` varchar(45) COLLATE utf8_spanish_ci DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `clientescompra`
--

INSERT INTO `clientescompra` (`idclientescompra`, `cedulacliente`, `nombrecliente`, `apellidocliente`, `usuarologuin`, `contrasena`, `tipodocumento`, `telefonocliente`, `mailcliente`, `pais`, `departamento`, `ciudad`, `direccionentrega`, `fecharegistro`) VALUES
(1, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, '10375944566', 'Juan Camilo ', 'Noriega Hoyos', 'juan.noriega', '04c35880cd2d2d0ad3b9445db36956d4', 1, '2310324', 'juan@gmail.com', 'Colombia', 'Antioquia', 'Medellin', 'Calle 5a nro 43b 25', '2015-06-10'),
(5, '12345', 'Alberto', 'noriega', 'juan.noriegaho', '04c35880cd2d2d0ad3b9445db36956d4', 1, '213232', 'juan@gmail.com', 'Colombia', 'Antioquia', 'Medellin', 'Calle 5a nro 43b 25', '2015-06-11'),
(6, '121212121212', 'Andres', 'Sierra', 'sierra', '025e5171bcd5eefd2fc3632a8cfd13e6', 1, '44444', 'sierra@drink.com', 'Colombia', 'Antioquia', 'Medellin', 'Calle 5a nro 43b 25', '2015-06-12'),
(7, '11111', 'Guillermo', 'Alzate', 'guillermo.alzate', '04c35880cd2d2d0ad3b9445db36956d4', 1, '2310324', 'juan.noriega@drink.com.co', 'Colombia', 'Antioquia', 'Medellín', 'Cra 36a nro 36 - 8', '2015-06-18'),
(8, '98553333', 'Andres', 'Sierra', 'sasierra', '1bbd886460827015e5d605ed44252251', 1, '4447651', 'sierra@drink.com.co', 'Colombia', 'Antioquia', 'Medellín', 'calle 5a nro 43b-25', '2015-06-19'),
(9, '12345678', 'Alberto ', 'Monsalve', 'alberto.monsalva', '04c35880cd2d2d0ad3b9445db36956d4', 1, '2310324', 'juan1387@gmail.com', 'Colombia', 'Antioquia', 'Medellin', 'Cra 36 a nro 39 24', '2015-07-02'),
(10, '123456789', 'sdsd', 'sdsd', 'dsds.sdsd', '04c35880cd2d2d0ad3b9445db36956d4', 1, '23232', 'juan1387@gmail.com', 'Colombia', 'Antioquia', 'Medellin', 'Calle 5a nro 43b 25', '2015-07-02'),
(11, '112233', 'juan', 'hoyo', 'juan.hoyos', '04c35880cd2d2d0ad3b9445db36956d4', 1, '11111', 'juan1387@gmail.com', 'Colombia', 'Colombia', 'Colombia', 'Calle 5a nro 43b 25', '2015-07-02'),
(12, '1017145571', 'Michelle', 'Durando', 'Michy', '25d55ad283aa400af464c76d713c07ad', 1, '2686259', 'riumsas@gmail.com', 'Colombia', 'Antioquia', 'Medellin', 'Calle 5a nro 43b 25', '2015-07-03');
...
`iddetallepagos` int(11) NOT NULL,
  `factura` varchar(45) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `detallepagos` (`iddetallepagos`, `factura`, `producto`, `sexo`, `color`, `cantidad`, `valorunitario`, `talla`, `estado`) VALUES
(41, '638915', 1, 1, 1, 1, 150000, 18, 1),
(42, '697215', 1, 1, 1, 4, 150000, 18, 1),
(43, '751615', 1, 3, 2, 1, 150000, 17, 1),
(44, '526915', 1, 2, 1, 1, 150000, 4, 1),
(45, '886715', 1, 2, 1, 2, 150000, 3, 1),
(46, '894215', 1, 2, 2, 1, 150000, 1, 1),
(47, '236815', 2, 3, 2, 1, 175000, 2, 1),
(48, '122815', 1, 1, 2, 1, 150000, 2, 1),
(49, '122815', 2, 3, 2, 3, 175000, 2, 1),
(50, '283915', 2, 3, 2, 1, 175000, 2, 1),
(51, '957615', 1, 2, 1, 1, 150000, 3, 1),
(52, '575215', 1, 2, 1, 1, 150000, 3, 1);
...
(4, 'Camiseta Manga Corta', 'Camiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\nCamiseta Manga Corta\r\n', 'es', 2),
(6, 'Camiseta Manga Corta', 'italiano', 'it', 2),
(7, 'Camiseta Manga Corta', 'ingles', 'en', 2);
...
INSERT INTO `itemslider` (`idsliderMain`, `img`, `seo`, `titulo`, `estado`, `idioma`, `slider`, `login`) VALUES
(1, 'rigobeto-uran-giro.jpg', 'gorigogo', 'rigobeto-uran-giro', 1, 'es', 1, NULL),
(5, 'rigobeto-uran-giro.jpg', 'vamoze', 'rigobeto-uran-giro', 1, 'it', 1, NULL),
(6, 'rigobeto-uran-giro.jpg', 'vamos', 'rigobeto-uran-giro', 1, 'en', 1, NULL),
(7, 'affinity.jpeg', 'affinity', 'affinity', 1, 'es', 1, NULL);
...
`idmenu` int(11) NOT NULL,
  ...
  `nivel_privacidad` int(11) NOT NULL,
  `orden` varchar(1) COLLATE utf8_spanish_ci NOT NULL,
  `estado` int(11) DEFAULT NULL,
  `submenu` bit(1) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=8 ;
...
INSERT INTO `menu` (`idmenu`, `nombreitem`, `url`, `nivel_privacidad`, `orden`, `estado`, `submenu`) VALUES
(1, 'Inicio', 'home', 0, 'a', 1, b'0'),
(2, 'Contáctame', 'contacto', 0, 'h', 1, b'1'),
(3, 'Acerca de mi', 'profile', 0, 'e', 1, b'0'),
(4, 'Noticias', 'news', 0, 'd', 1, b'0'),
(5, 'Labor social', 'social', 0, 'c', 1, b'0'),
(6, 'Tienda', 'shop', 0, 'b', 1, b'0'),
(7, 'Mis pedidos', 'my_pedidos', 1, 'f', 1, b'0');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `menuxidioma`
--

CREATE TABLE IF NOT EXISTS `menuxidioma` (
`idmenuxidioma` int(11) NOT NULL,
  `idioma` varchar(45) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `menu` int(11) NOT NULL,
  `traduccion` varchar(45) DEFAULT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=22 ;

--
-- Volcado de datos para la tabla `menuxidioma`
--

INSERT INTO `menuxidioma` (`idmenuxidioma`, `idioma`, `menu`, `traduccion`) VALUES
(1, 'es', 1, 'Inicio'),
(2, 'en', 1, 'Home'),
(3, 'it', 1, 'Iniziazione'),
(4, 'es', 2, 'Contáctame'),
...
(11, 'en', 4, 'News'),
(12, 'it', 4, 'Notizie'),
(13, 'es', 5, 'Labor social'),
(14, 'en', 5, 'Social work'),
(15, 'it', 5, 'Lavoro sociale'),
(16, 'es', 6, 'Tienda'),
(17, 'en', 6, 'Shop'),
(18, 'it', 6, 'Negozio'),
(19, 'es', 7, 'Mis pedidos'),
(20, 'en', 7, 'My orders'),
(21, 'it', 7, 'I miei ordini');
...
`idpagos` int(11) NOT NULL,
  `codigopago` varchar(45) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `fecha` datetime DEFAULT NULL,
  `identificador` varchar(70) DEFAULT NULL,
  `estado` int(11) DEFAULT NULL,
  `id_forma_pago` int(11) DEFAULT NULL,
  `valor_pagado` float DEFAULT NULL COMMENT '	',
  `ticketID` int(11) DEFAULT NULL COMMENT '		',
  `id_clave` varchar(45) DEFAULT NULL,
  `id_cliente` varchar(45) DEFAULT NULL,
  `franquicia` varchar(45) DEFAULT NULL,
...
INSERT INTO `pagos` (`idpagos`, `codigopago`, `fecha`, `identificador`, `estado`, `id_forma_pago`, `valor_pagado`, `ticketID`, `id_clave`, `id_cliente`, `franquicia`, `codigo_banco`, `transaccion`, `banco`) VALUES
(88, '122815', '2015-06-23 04:32:12', '28192310005628583', 1, 29, 675000, 2147483647, 'Rium10260', '10375944566', '', 1022, 1028433, 'Banco Union Colombiano'),
(91, '196515', '2015-06-23 04:39:16', '98705290005628652', 11, -1, -1, -1, '-1', '-1', ' -1 ', -1, -1, '-1'),
(86, '236815', '2015-06-23 04:22:06', '97127070005628472', 1, 29, 175000, 2147483647, 'Rium10260', '10375944566', '', 1022, 1028428, 'Banco Union Colombiano'),
(83, '273315', '2015-06-23 02:26:37', '36582630005627035', 11, 29, 150000, 2147483647, 'Rium10260', '10375944566', '  ', 1022, 1028277, 'Banco Union Colombiano'),
(89, '283915', '2015-06-23 04:33:22', '90983190005628593', 1, 29, 175000, 2147483647, 'Rium10260', '10375944566', '', 1022, 1028435, 'Banco Union Colombiano'),
(73, '287615', '2015-06-23 12:19:51', '2360950005625870', 11, 29, 150000, 2147483647, 'Rium10260', '10375944566', '  ', 1040, 1028234, 'BANCO AGRARIO'),
(90, '296215', '2015-06-23 04:39:04', '10501670005628646', 11, NULL, 175000, NULL, NULL, '10375944566', NULL, NULL, NULL, NULL),
(80, '314615', '2015-06-23 01:27:43', '26445080005626456', 11, -1, -1, -1, '-1', '-1', ' -1 ', -1, -1, '-1'),
(85, '319515', '2015-06-23 04:10:45', '63074390005628343', 11, NULL, 775000, NULL, NULL, '10375944566', NULL, NULL, NULL, NULL),
(75, '357415', '2015-06-23 12:30:39', '65570440005625980', 11, NULL, 150000, NULL, NULL, '10375944566', NULL, NULL, NULL, NULL),
(81, '411415', '2015-06-23 01:39:01', '54853080005626554', 11, -1, -1, -1, '-1', '-1', ' -1 ', -1, -1, '-1'),
(76, '526915', '2015-06-23 12:31:45', '94059040005625991', 1, 29, 150000, 2147483647, 'Rium10260', '10375944566', '', 1022, 1028243, 'Banco Union Colombiano'),
(79, '531415', '2015-06-23 01:17:30', '63823210005626359', 11, NULL, 300000, NULL, NULL, '10375944566', NULL, NULL, NULL, NULL),
(68, '556115', '2015-06-19 06:16:32', '95637270005606881', 11, -1, -1, -1, '-1', '-1', ' -1 ', -1, -1, '-1'),
(77, '558415', '2015-06-23 12:32:41', '63992220005625997', 11, -1, -1, -1, '-1', '-1', ' -1 ', -1, -1, '-1'),
(93, '575215', '2015-07-03 11:17:57', '49369600005726314', 1, 29, 150000, 2147483647, 'Rium10260', '1017145571', '', 1022, 1031986, 'Banco Union Colombiano'),
(69, '638915', '2015-06-23 10:36:42', '4438380005624604', 1, 29, 150000, 2147483647, 'Rium10260', '10375944566', '  ', 1022, 1028162, 'Banco Union Colombiano'),
(71, '693115', '2015-06-23 12:07:41', '39739080005625736', 11, -1, -1, -1, '-1', '-1', ' -1 ', -1, -1, '-1'),
(70, '697215', '2015-06-23 10:47:11', '63493010005624749', 1, 29, 600000, 2147483647, 'Rium10260', '10375944566', '  ', 1022, 1028169, 'Banco Union Colombiano'),
(72, '751615', '2015-06-23 12:18:47', '61745780005625858', 1, 29, 150000, 2147483647, 'Rium10260', '10375944566', '  ', 1022, 1028232, 'Banco Union Colombiano'),
(67, '761315', '2015-06-19 05:59:47', '97046480005606770', 11, NULL, 150000, NULL, NULL, '10375944566', NULL, NULL, NULL, NULL),
(78, '764115', '2015-06-23 12:43:09', '93060620005626080', 11, 29, 150000, 2147483647, 'Rium10260', '10375944566', '  ', 1022, 1028248, 'Banco Union Colombiano'),
(74, '843415', '2015-06-23 12:26:19', '19721400005625937', 11, NULL, 150000, NULL, NULL, '10375944566', NULL, NULL, NULL, NULL),
(82, '886715', '2015-06-23 01:49:11', '94389240005626632', 1, 29, 300000, 2147483647, 'Rium10260', '10375944566', '', 1022, 1028259, 'Banco Union Colombiano'),
(84, '894215', '2015-06-23 02:26:42', '29770530005627038', 1, 29, 150000, 2147483647, 'Rium10260', '10375944566', '', 1022, 1028279, 'Banco Union Colombiano'),
(92, '957615', '2015-06-25 04:24:25', '57011110005644596', 1, 29, 150000, 2147483647, 'Rium10260', '10375944566', '', 1022, 1029376, 'Banco Union Colombiano'),
(87, '995415', '2015-06-23 04:25:03', '25784680005628502', 11, NULL, 175000, NULL, NULL, '10375944566', NULL, NULL, NULL, NULL);
...
(1, 'Rigo Pro Bélgica', '1', 'Rigo-Pro-Belgica.jpg', 'URCEE004-11.jpg', 'URCEE004-31.jpg', 'belgica-rigo.jpg', 150000, 300000, 'Camisas, Rigoberto Urán', NULL, '2015rupb01'),
(2, 'Rigo Pro Nacional', '1', 'Rigo-Uran-Uniformes-51.jpg', 'Rigo-Uran-Uniformes-56.jpg', 'Rigo-Uran-Uniformes-57.jpg', 'belgica-rigo.jpg', 175000, 200000, 'Camisa Rigoberto uran', 'n', '2015rupn01');
...
INSERT INTO `submenu` (`idsubmenu`, `idmenu`, `orden`, `nombre`, `url`, `idioma`, `estado`) VALUES
(1, 2, 'a', 'Contacto', 'contacto', 'es', '1'),
(2, 2, 'a', 'Contact', 'contacto', 'en', '1'),
(3, 2, 'a', 'Contatto', 'contacto', 'it', '1'),
(4, 2, 'b', 'Contacto prensa', 'contacto_prensa', 'es', '1'),
(5, 2, 'b', 'Press Contact', 'contacto_prensa', 'en', '1'),
(6, 2, 'b', 'Contatto Stampa', 'contacto_prensa', 'it', '1'),
(7, 0, 'b', NULL, NULL, NULL, NULL);
...
(3, 'Nit Empresa', 1),
(4, 'Número Único de Identificación', 1),
(5, 'Tarjeta de Identidad', 1),
(6, 'Pasaporte', 1),
(9, 'Registro Civil de Nacimiento', 1),
(10, 'Documento de Identificación Extranjero', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `usuariospanel`
--

CREATE TABLE IF NOT EXISTS `usuariospanel` (
`idusuariospanel` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `usuariospanel`
--

INSERT INTO `usuariospanel` (`idusuariospanel`, `nombre`, `cedula`, `fecha`, `correo`, `login`, `pwd`, `rol`, `estado`) VALUES
(1, 'Juan Camilo', '1037594566', NULL, 'juan1387@gmail.com', 'juan.noriega', '04c35880cd2d2d0ad3b9445db36956d4', '1', '1');
...
ALTER TABLE `detallepagos`
 ADD PRIMARY KEY (`iddetallepagos`), ADD UNIQUE KEY `iddetallepagos_UNIQUE` (`iddetallepagos`), ADD KEY `fk_detallepagos_pagos1_idx1` (`factura`);
...
--
-- Indices de la tabla `menuxidioma`
--
ALTER TABLE `menuxidioma`
 ADD PRIMARY KEY (`idmenuxidioma`), ADD KEY `fk_menuxidioma_idioma1_idx` (`idioma`), ADD KEY `fk_menuxidioma_menu1_idx` (`menu`);

--
-- Indices de la tabla `pagos`
--
ALTER TABLE `pagos`
 ADD PRIMARY KEY (`codigopago`), ADD UNIQUE KEY `idpagos_UNIQUE` (`idpagos`);
...
--
-- Indices de la tabla `usuariospanel`
--
ALTER TABLE `usuariospanel`
 ADD PRIMARY KEY (`idusuariospanel`);
...
--
ALTER TABLE `clientescompra`
MODIFY `idclientescompra` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `detallepagos`
MODIFY `iddetallepagos` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=53;
--
-- AUTO_INCREMENT de la tabla `detallexproducto`
--
ALTER TABLE `detallexproducto`
MODIFY `iddetallexproducto` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT de la tabla `inventario`
--
ALTER TABLE `inventario`
MODIFY `idinventerio` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
-- AUTO_INCREMENT de la tabla `menuxidioma`
--
ALTER TABLE `menuxidioma`
MODIFY `idmenuxidioma` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=22;
--
-- AUTO_INCREMENT de la tabla `pagos`
--
ALTER TABLE `pagos`
MODIFY `idpagos` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=94;
--
...
--
ALTER TABLE `recursos`
MODIFY `idrecursos` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `submenu`
MODIFY `idsubmenu` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
-- AUTO_INCREMENT de la tabla `usuariospanel`
--
ALTER TABLE `usuariospanel`
MODIFY `idusuariospanel` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `detallepagos`
ADD CONSTRAINT `fk_detallepagos_pagos1` FOREIGN KEY (`factura`) REFERENCES `pagos` (`codigopago`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
-- Filtros para la tabla `menuxidioma`
--
ALTER TABLE `menuxidioma`
ADD CONSTRAINT `fk_menuxidioma_idioma1` FOREIGN KEY (`idioma`) REFERENCES `idioma` (`abrevitura`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `fk_menuxidioma_menu1` FOREIGN KEY (`menu`) REFERENCES `menu` (`idmenu`) ON DELETE NO ACTION ON UPDATE NO ACTION;
